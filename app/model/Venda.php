...
class Vendas {
    ...
    public function calcularTotal(array $itens): float {
        return array_sum(array_map(fn(ItemVenda $i) => $i->getSubtotal(), $itens));
    }
    ...
    public function getClienteId(): ?int { return $this->clienteId ?? null; }
    public function setClienteId(?int $clienteId): void { $this->clienteId = $clienteId; }

    public function getCaixaId(): ?int { return $this->caixaId ?? null; }
    ...
    public function getFormaPagamento(): ?string { return $this->formaPagamento ?? null; }
